...
class TestOnlySiblingTree {

    @Test
    void siblingOnly(){
        try{
            System.out.println("Create a sibling only tree.");
            ...
            onlySiblingsTree.addAllSiblings("William I", Robert,William,WilliamII,Adela,Stephen,Henry,
